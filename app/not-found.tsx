...
export default function NotFound() {
  return (
    <div className="mx-auto flex w-full max-w-2xl flex-col items-start gap-6 px-6 py-32 text-center sm:text-left">
      <span className="font-handwritten text-2xl text-accent-red">page torn out...</span>
